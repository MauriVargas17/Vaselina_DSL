 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.vaselina.impl.DoWhileExpressionImpl#getLoopConditon <em>Loop Conditon</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.vaselina.impl.DoWhileExpressionImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoWhileExpressionImpl extends BodyStatementImpl implements DoWhileExpression
{
  ...
  {
    return VaselinaPackage.Literals.DO_WHILE_EXPRESSION;
  }
  ...
  public NotificationChain basicSetLoopConditon(varExpression newLoopConditon, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VaselinaPackage.DO_WHILE_EXPRESSION__LOOP_CONDITON, oldLoopConditon, newLoopConditon);
  ...
  public void setLoopConditon(varExpression newLoopConditon)
  {
    if (newLoopConditon != loopConditon)
    {
      ...
      if (loopConditon != null)
        msgs = ((InternalEObject)loopConditon).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VaselinaPackage.DO_WHILE_EXPRESSION__LOOP_CONDITON, null, msgs);
      if (newLoopConditon != null)
        msgs = ((InternalEObject)newLoopConditon).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VaselinaPackage.DO_WHILE_EXPRESSION__LOOP_CONDITON, null, msgs);
      msgs = basicSetLoopConditon(newLoopConditon, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VaselinaPackage.DO_WHILE_EXPRESSION__LOOP_CONDITON, newLoopConditon, newLoopConditon));
  }
  ...
  public EList<BodyStatement> getBody()
  {
    if (body == null)
    {
      body = new EObjectContainmentEList<BodyStatement>(BodyStatement.class, this, VaselinaPackage.DO_WHILE_EXPRESSION__BODY);
    }
    return body;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case VaselinaPackage.DO_WHILE_EXPRESSION__LOOP_CONDITON:
        return basicSetLoopConditon(null, msgs);
      case VaselinaPackage.DO_WHILE_EXPRESSION__BODY:
